...
cljs.core.nil_iter = function nil_iter() {
  "undefined" === typeof cljs.core.t5436 && (cljs.core.t5436 = function(b, c) {
    this.nil_iter = b;
    this.meta5437 = c;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
  }, cljs.core.t5436.cljs$lang$type = !0, cljs.core.t5436.cljs$lang$ctorStr = "cljs.core/t5436", cljs.core.t5436.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write.call(null, c, "cljs.core/t5436");
  ...
  }, cljs.core.t5436.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta5437;
  }, cljs.core.t5436.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t5436(this.nil_iter, c);
  }, cljs.core.__GT_t5436 = function(b, c) {
    return new cljs.core.t5436(b, c);
  });
...
clui_om.vanilla.report_agent = function() {
  return alert("User Agent is: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.userAgent.PLATFORM));
};
clui_om.vanilla.echo = function(a) {
  var b = goog.dom.forms.getFormDataMap(clui_om.vanilla.$form).get("spamInput");
  a.preventDefault();
  console.log(b);
  console.log("echoing..." + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b));
  return goog.dom.setTextContent(clui_om.vanilla.$output, "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b));
};
clui_om.vanilla.initialize = function() {
  console.log("initializing vanilla...");
  goog.dom.classes.add(clui_om.vanilla.$output, "vanilla-border");
  goog.dom.setTextContent(clui_om.vanilla.$output, "Dynamically created by the Google Closure at: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(new Date));
  goog.events.listen(clui_om.vanilla.$output, goog.events.EventType.CLICK, function(a) {
    return goog.dom.classes.toggle(clui_om.vanilla.$output, "vanilla-border");
  });
  goog.events.listen(clui_om.vanilla.$trigger, goog.events.EventType.CLICK, function(a) {
    return clui_om.vanilla.echo.call(null, a);
  });
  return goog.events.listen(clui_om.vanilla.$agent, goog.events.EventType.CLICK, function(a) {
    return clui_om.vanilla.report_agent.call(null);
  });
};
goog.exportSymbol("clui_om.vanilla.initialize", clui_om.vanilla.initialize);
