...
return [cljs.core.str((function (){var G__27861 = (new goog.Uri());
G__27861.setScheme(cljs.core.name.call(null,(function (){var or__3628__auto__ = scheme;
...
if(cljs.core.truth_((function (){var or__3628__auto__ = clojure.string.blank_QMARK_.call(null,k);
if(cljs.core.truth_(or__3628__auto__)){
return or__3628__auto__;
} else {
...
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__3628__auto__ = headers;
if(cljs.core.truth_(or__3628__auto__)){
return or__3628__auto__;
} else {
return "";
